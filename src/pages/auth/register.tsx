...
export default function Register() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (signUpError) {
      ...
      if (oauthParams && oauthParams.client_id && oauthParams.redirect_uri) {
        ...
        // Normal registration, go to dashboard
        router.push("/");
      }
    }
  };
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-orange-50 via-pink-50 to-blue-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 p-4">
      <SEO title="Sign Up - FanDragon Identity" />
      ...
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <p className="text-muted-foreground text-lg">Create your FanDragon account</p>
        </div>
        ...
        <div className="text-center text-sm">
          ...
          <Link 
            href={`/auth/login${oauthParams ? `?${new URLSearchParams(oauthParams as any).toString()}` : ""}`}
